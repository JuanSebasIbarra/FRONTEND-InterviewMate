export const es = {
  ...
  templateCreation: {
    ...
    subtitle: 'Completa los campos con tu voz o teclado para crear una plantilla personalizada de entrevista.',
    formLabel: 'FORMULARIO',
    backButton: 'Volver',
    dictation: 'Dictado',
    dictationHelp: 'Selecciona un campo y dicta para llenar',
    browserNotSupported: 'Tu navegador no soporta dictado por voz.',
    selectFieldPrompt: 'Selecciona un campo para empezar.',
    listening: 'Escuchando',
    dictationApplied: 'Dictado aplicado a',
    speechError: 'Error al procesar el audio.',
    speechStopped: 'Dictado detenido.',
    speechPaused: 'Dictado pausado.',
    browserSpeechNotSupported: 'Tu navegador no soporta reconocimiento de voz.',
    startError: 'No se pudo iniciar el reconocimiento de voz.',
    startButton: 'Iniciar',
    stopButton: 'Detener',
    activeField: 'CAMPO ACTIVO',
    activeFieldHelp: 'Este es el campo que se llenará al dictar.',
    fieldEnterprise: 'Empresa',
    fieldType: 'Tipo de entrevista',
    fieldPosition: 'Puesto',
    fieldWorkingArea: 'Área de trabajo',
    fieldDescription: 'Descripción',
    fieldRequirements: 'Requisitos',
    fieldGoals: 'Objetivos',
    fieldBusinessContext: 'Contexto del negocio',
    placeholderEnterprise: 'Ej. Google',
    placeholderPosition: 'Ej. Desarrollador Frontend',
    placeholderWorkingArea: 'Ej. Desarrollo web',
    placeholderDescription: 'Describe el puesto y las responsabilidades principales...',
    placeholderRequirements: 'Lista los requisitos técnicos y habilidades necesarias...',
    placeholderGoals: 'Define qué esperas lograr en esta entrevista...',
    placeholderBusinessContext: 'Proporciona contexto sobre la empresa y el equipo...',
    interviewTypeTechnical: 'Técnica',
    interviewTypeHR: 'Recursos Humanos',
    interviewTypePsychological: 'Psicológica',
    cancelButton: 'Cancelar',
    createButton: 'Crear plantilla',
    creating: 'Creando...',
    templateCreatedNoId: 'Error: no se recibió ID de la plantilla creada.',
